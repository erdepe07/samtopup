<div class="form-row pt-3">
    <div class="col">
        <input type="text" name="zone_id" class="form-control" placeholder="Masukkan User ID" autocomplete="off">
    </div>
    <div class="col">
        <select name="user_id" class="form-control">
            <option value="001">America</option>
            <option value="002">Europe</option>
            <option value="003">Asia</option>
            <option value="004">TW, HK, MO</option>
        </select>
    </div>
