    ...
    <div>
        <div class="col-12" style="background: var(--warna_2) !important;padding:0px !important">
            <ul class="nav nav-pills tab-category" role="tablist">
                <?php $no = 1; foreach ($games as $game): ?>
                <li class="nav-item col text-center mt-md-0" style="padding:0px !important">
                    <a class="nav-link <?= $no == 1 ? 'active' : ''; ?>"
                       data-bs-toggle="pill"
                       href="#pills-<?= url_title($game['category'], '-', true); ?>"
                       role="tab">
                        <?php if ($game['category'] == 'Games'): ?>
                            <i class="fa fa-gamepad mb-2" style="font-size:25px"></i>
                        <?php elseif ($game['category'] == 'Voucher'): ?>
                            <i class="fa fa-ticket mb-2" style="font-size:25px"></i>
                        <?php elseif ($game['category'] == 'Pulsa'): ?>
                            <i class="fa fa-phone mb-2" style="font-size:25px"></i>
                        <?php elseif ($game['category'] == 'Data'): ?>
                            <i class="fa fa-mobile mb-2" style="font-size:25px"></i>
                        <?php elseif ($game['category'] == 'PLN'): ?>
                            <i class="fa fa-flash mb-2" style="font-size:25px"></i>
                        <?php endif; ?>
                        <br><?= $game['category']; ?>
                    </a>
                </li>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade <?= $no == 1 ? 'show active' : ''; ?>"
             id="pills-<?= url_title($game['category'], '-', true); ?>"
             role="tabpanel">
                ...
                <div class="col-sm-3 col-lg-2 col-4 text-center" style="display:grid;">
                    <div class="card mb-3 phy-card">
                        <a href="<?= base_url(); ?>/games/<?= $loop['slug']; ?>" class="product_list">
                            <div class="card-game" style="padding:0.85rem 1.30rem;">
                                <img src="<?= base_url(); ?>/assets/images/games/<?= $loop['image']; ?>"
                                     class="img-fluid phy-img"
                                     style="border-radius:10px;">
                            </div>
                            <div class="card-title phy-card-title">
                                <?= $loop['games']; ?>
                            </div>
                        </a>
                    </div>
